      ...
      <div className="grid grid-cols-1 gap-6 py-6 md:grid-cols-2 lg:gap-8">
        ...
        <div className="">
          <p className="text-justify">
            Hi, I am Khaled AbdElnasser, I am a Senior Game developer. I work from Dubai, UAE. I have rich
            experience in building, designing & customizing Games, VR apps, mobile Games etc.
          </p>
